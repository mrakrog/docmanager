...
INSTALLED_APPS = [
    ...
    'rest_framework',
    'corsheaders',
    'django_extensions',  # Aseguramos que django_extensions esté instalado
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            ...
            'debug': DEBUG,  # Asegurar que el modo debug esté habilitado en las plantillas
        },
    },
]
...
# Configuración para mostrar errores detallados en desarrollo
if DEBUG:
